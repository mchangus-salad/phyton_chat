...
urlpatterns += [
    ...
    path('security/events/export/', security_events_export, name='security-events-export'),
    path('audit/patient-cases/', patient_case_audit, name='audit-patient-cases'),
